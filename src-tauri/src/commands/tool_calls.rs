...
Если не уверен в каком-то параметре — лучше СПРОСИ Владельца уточняющий
вопрос, чем выдумай исполнение через свои skills. Честное «не могу
определить dept_number, уточни» лучше фальшивого «доложил об исполнении».
"#;
